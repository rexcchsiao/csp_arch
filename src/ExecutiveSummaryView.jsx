...
const ExecutiveSummaryView = () => {
  ...
  const buyerScorecardSignals = [
    ...
    {
      criterion: 'Lifecycle, recovery, and facility-event coordination are becoming first-class requirements',
      marketSignal: 'NVIDIA Mission Control positions cluster life cycle, autonomous recovery, building-management integration, and now explicitly highlights air-gapped deployment plus leak-detection validation in Mission Control 2.3.',
      whyItChangesProcurement: 'This shifts buyer attention from “can it be installed?” to “who owns Day-2 risk when the cluster is live, disconnected, or hit by a power/cooling event?”.',
      foxconnMove: 'Sell Lifecycle Control Tower, Air-Gap Content Lifecycle, and Facility-Aware Capacity Assurance as accountable operating outcomes.',
