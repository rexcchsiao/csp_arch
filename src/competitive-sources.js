...
export const competitiveSources = {
  ...
  nvidia: [
    ...
    { name: 'NVIDIA Mission Control', url: 'https://www.nvidia.com/en-us/data-center/mission-control/', description: 'AI Factory operations platform - "world-class operations team delivered as software"', relevance: 'Competes with our Remote Ops offering and strongly validates that AI infrastructure buyers now fund lifecycle operations, not just hardware delivery', lastVerified: '2026-03-25', keyFeature: 'NVIDIA frames Mission Control around cluster lifecycle operations: workload scheduling/orchestration, autonomous recovery, continuous health checks, advanced power optimization, and building-management integration for power/cooling events.', positioning: 'Targets enterprises running AI factories at scale; designed for NVIDIA DGX Cloud and NVIDIA-certified infrastructure', ourAdvantage: 'Foxconn provides neutral infrastructure (NVIDIA + AMD), on-premise sovereign AI deployment, custom L9-L10 firmware integration, and avoids vendor lock-in while preserving brownfield datacenter compatibility.', limitation: 'Optimized for NVIDIA DGX datacenters; building management integration and validated recovery flows are strongest inside NVIDIA-certified infrastructure choices' },
