...
export const competitiveSources = {
  ...
  standards: [
    ...
    { name: 'OpenCost', url: 'https://opencost.io/', description: 'Vendor-neutral open-source cost monitoring and allocation for cloud-native and Kubernetes environments', relevance: 'Useful proof that GPU / container cost visibility is becoming standardized; the differentiated software value moves up-stack into showback, chargeback, quota policy, and budget accountability for shared AI infrastructure.', lastVerified: '2026-03-31', keyFeature: 'OpenCost positions itself around real-time cost allocation, standard cost visibility, and showback / chargeback support across Kubernetes resources including GPU, CPU, memory, storage, and custom-priced on-prem clusters.', limitation: 'Cost measurement alone does not tell platform teams who should own runaway inference spend, how shared GPU costs should be apportioned, or how to connect utilization and token economics back to tenant policy and CFO-visible budget guardrails.', ourAdvantage: 'Foxconn can turn commodity cost signals into a billable AI cost-governance layer: GPU showback / chargeback, quota and budget guardrails, tenant-level cost accountability, and inference optimization workflows tied directly to on-prem AI clusters instead of generic cloud dashboards.' },
    { name: 'FinOps Foundation Personas', url: 'https://www.finops.org/framework/personas/', description: 'Official FinOps Foundation framework page showing that cost governance is a cross-functional operating model, not a single dashboard owned by one team', relevance: 'Useful proof that AI / cloud cost governance naturally spans Finance, engineering, procurement, ITAM, and operations—supporting our argument that software can open recurring FinOps and budget-governance conversations after hardware delivery.', lastVerified: '2026-04-02', keyFeature: 'The FinOps Foundation describes FinOps as collaborative work across stakeholder groups, with allied personas such as ITAM, ITFM/TBM, sustainability, security, and ITSM intersecting around budgeting, forecasting, optimization, reporting, and accountability.', limitation: 'The framework validates shared cost-governance ownership, but it does not by itself define tenant quota policy, GPU showback rules, token-budget guardrails, or how to turn AI cost signals into enforceable platform workflows.', ourAdvantage: 'Foxconn can use this operating-model proof to frame software as the owner of shared GPU economics after delivery: quota policy, showback / chargeback, exception workflow, budget guardrails, and inference-cost accountability that Finance and platform teams can both recognize.' },
    { name: 'NIST Secure Software Development Framework (SSDF)', url: 'https://csrc.nist.gov/Projects/ssdf', description: 'NIST guidance for secure software development practices used by producers and software purchasers', relevance: 'Useful proof that secure update governance, provenance, and verifiable development / release practices are becoming procurement language—not just engineering hygiene.', lastVerified: '2026-03-30', keyFeature: 'NIST frames SSDF as a common vocabulary for secure software development and explicitly notes it can support acquisition and supplier evaluation by software purchasers.', limitation: 'SSDF defines practice categories and expected discipline, but it does not by itself provide fleet-level attestation, rollback evidence, firmware provenance records, or brownfield update orchestration across AI server environments.', ourAdvantage: 'Foxconn can translate SSDF from policy into an attachable software service: firmware / image provenance tracking, signed update workflows, approval records, rollback evidence, and audit-ready reporting tied to actual AI server lifecycle operations.' }
  ],
  enterprisePlatforms: [
    {
      name: 'VAST AI OS',
